    ...
    return(
        <div className="h-full w-invoice absolute left-[60px] z-1 top-0 rounded-r-[1.25rem] bg-[#fff] px-14 pt-15 shadow-logobg shadow-2xl dark:bg-[#141625]">
            ...
            <div className="grid mb-6">
                ...
                <input className="h-12 outline-none rounded-sm border-[#DFE3FA] border border-solid" type="text" />
            </div>
            <div className="flex gap-6">
                <div className="grid gap-2">
                    <span className="text-span text-[#7E88C3]">City</span>
                    <input className="h-12 w-[9.5rem] rounded-sm border-[#DFE3FA] border border-solid" type="text" />
                </div>
                <div className="grid gap-2">
