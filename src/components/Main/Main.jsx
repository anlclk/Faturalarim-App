...
export default function Main() {
    return(
        <main className="s:w-mobilecontainer md:w-tablet mx-auto md:pt-[78px] pt-[36px] dark:bg-[#000]">
            <div className="flex justify-between mb-8">
                <div>
                    <h1 className="text-2xl leading-5 font-bold dark:text-[#fff]">Invoices</h1>
                    <span className="text-span leading-3.5 text-spancolor">7 invoices</span>
                </div>
                <div className="flex items-center gap-3.5">
                    <h2 className="text-s font-bold dark:text-[#fff]">Filter</h2>
                ...
                <div className="px-6 py-7 bg-[#fff] rounded-lg box-card md:flex md:gap-21 md:items-center md:justify-between dark:bg-[#1E2139]">
                    <div className="flex justify-between">
                        <div className="md:flex md:gap-7">
                            <h1 className="mb-6 font-bold text-s leading-3.5 md:mb-0 dark:text-[#fff]"><span className="text-[#7E88C3]">#</span>RT3080</h1>
                            <span className="text-span leading-3.5 text-spancolor md:mr-13">Due 19 Aug 2021</span>
                        </div>
                        <h3 className="text-span leading-3.5 text-spancolor dark:text-[#fff]">Jensen Huang</h3>
                    </div>
                    <div className="flex justify-between md:gap-10">
                        <h1 className="pt-4 text-s font-bold md:py-0 md:flex md:items-center dark:text-[#fff]">£ 1,800.90</h1>
