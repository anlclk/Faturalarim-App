       ...
       <>
        <header className="sticky top-0 h-17 w-full flex z-10 justify-between bg-header mb-9 md:w-17 md:h-full md:mb-0 md:flex-col md:fixed md:content-between md:rounded-r-xl dark:bg-[#1E2139]">
            ...
            <div className="h-full flex items-center justify-center md:w-full md:block md:h-[144px]">
                <div className="h-full flex items-center pr-6 border-r border-headerborder md:pr-0 md:h-17 md:flex md:items-center md:justify-center md:border-b md:border-headerborder md:border-r-0">
                    <button onClick={changeTheme} className="border-0">
