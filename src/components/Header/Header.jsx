...
export default function Header() {
    return(
        <header className="h-17 w-full flex justify-between bg-header mb-9">
            ...
            <div className="h-full flex items-center justify-center">
                <div className="h-full flex items-center pr-6 border-r border-headerborder">
                ...
                <div className='px-6 py-5 rounded-[2rem]'>
