...
export default function Header() {
    return(
        <header className="h-17 flex justify-between bg-header mb-9">
            <div className="h-full flex gap-44 border-r-1 border-white-500">
            ...
            <div className="h-full w-17 flex items-center justify-center border-l border-headerborder">
                <div className='w-8 h-8 rounded-[2rem]'>
                    <img src={account} className='h-full w-full rounded-[2rem]' alt="" />
                </div>
            </div>      
        </header>
    );
